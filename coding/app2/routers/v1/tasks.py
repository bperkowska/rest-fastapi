...
from dependencies import DbSession, PositiveInt, CurrentUser
...
# D (Delete) - REQUIRES AUTHENTICATION
@router.delete("/{task_id}", status_code=status.HTTP_204_NO_CONTENT)
def delete_task(task_id: PositiveInt, db: DbSession, current_user: CurrentUser):
